...
public class Horse extends ChessPiece {
    ...
    public Horse() {
        super(CommonConstants.ChessPieces.HORSE);
    }
    ...
    public List<Position> makeAMove(Position currentPosition) {
        ...
        possiblePositions.add(new Position(currentPosition.getRow() - 1, currentPosition.getColumn() + 2));
        possiblePositions.add(new Position(currentPosition.getRow() + 1, currentPosition.getColumn() + 2));

        possiblePositions.add(new Position(currentPosition.getRow() - 1, currentPosition.getColumn() - 2));
        possiblePositions.add(new Position(currentPosition.getRow() + 1, currentPosition.getColumn() - 2));

        possiblePositions.add(new Position(currentPosition.getRow() + 2,currentPosition.getColumn() - 1));
        possiblePositions.add(new Position(currentPosition.getRow() + 2,currentPosition.getColumn() + 1));
